...
declare class LookAtModifier3D extends SkeletonModifier3D {
  ...
  origin_external_node: NodePathType
  ...
  connect<T extends SignalsOf<LookAtModifier3D>>(
    signal: T,
    method: SignalFunction<LookAtModifier3D[T]>
  ): number
   ...
   *
   */
  static ORIGIN_FROM_SPECIFIC_BONE: any
   ...
   *
   */
  static ORIGIN_FROM_EXTERNAL_NODE: any
}
