 ...
 *
 * Godot uses [CubemapArray]s internally for many effects, including the [Sky] if you set [member ProjectSettings.rendering/reflections/sky_reflections/texture_array_reflections] to `true`.
 *
...
declare class CubemapArray extends ImageTextureLayered {
  ...
  connect<T extends SignalsOf<CubemapArray>>(
    signal: T,
    method: SignalFunction<CubemapArray[T]>
  ): number
}
