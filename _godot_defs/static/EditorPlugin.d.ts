...
declare class EditorPlugin extends Node {
   ...
   *
   */
  protected _forward_3d_force_draw_over_viewport(
   ...
   *
   */
  protected _forward_3d_gui_input(
   ...
   *
   */
  protected _forward_canvas_force_draw_over_viewport(
    viewport_control: Control
  ): void
  ...
  connect<T extends SignalsOf<EditorPlugin>>(
    signal: T,
    method: SignalFunction<EditorPlugin[T]>
  ): number
