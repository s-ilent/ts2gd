...
declare class TileSetAtlasSource extends TileSetSource {
  ...
  /** The base tile size in the texture (in pixel). This size must be bigger than or equal to the TileSet's [code]tile_size[/code] value. */
  ...
  connect<T extends SignalsOf<TileSetAtlasSource>>(
    signal: T,
    method: SignalFunction<TileSetAtlasSource[T]>
  ): number
