...
declare class BaseMaterial3D extends Material {
  ...
  connect<T extends SignalsOf<BaseMaterial3D>>(
    signal: T,
    method: SignalFunction<BaseMaterial3D[T]>
  ): number
   ...
   *
   */
  static TEXTURE_BENT_NORMAL: any
   ...
   *
   */
  static FEATURE_BENT_NORMAL_MAPPING: any
   ...
   *
   */
  static FLAG_DISABLE_SPECULAR_OCCLUSION: any

  /**
   * Enables using [member z_clip_scale].
   *
   */
  static FLAG_USE_Z_CLIP_SCALE: any

  /**
   * Enables using [member fov_override].
   *
   */
  static FLAG_USE_FOV_OVERRIDE: any
   ...
   *
   */
  static STENCIL_MODE_DISABLED: any
   ...
   *
   */
  static STENCIL_MODE_OUTLINE: any
