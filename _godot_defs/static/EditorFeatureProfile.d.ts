...
declare class EditorFeatureProfile extends RefCounted {
  ...
  connect<T extends SignalsOf<EditorFeatureProfile>>(
    signal: T,
    method: SignalFunction<EditorFeatureProfile[T]>
  ): number
