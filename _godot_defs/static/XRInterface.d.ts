...
declare class XRInterface extends RefCounted {
  ...
  connect<T extends SignalsOf<XRInterface>>(
    signal: T,
    method: SignalFunction<XRInterface[T]>
  ): number
   ...
   *
   */
  static XR_PLAY_AREA_CUSTOM: any
