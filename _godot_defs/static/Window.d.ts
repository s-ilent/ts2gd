...
declare class Window extends Viewport {
  ...
  connect<T extends SignalsOf<Window>>(
    signal: T,
    method: SignalFunction<Window[T]>
  ): number
   ...
   *
   */
  static FLAG_EXCLUDE_FROM_CAPTURE: any

  /**
   * Signals the window manager that this window is supposed to be an implementation-defined "popup" (usually a floating, borderless, untileable and immovable child window).
   *
   */
  static FLAG_POPUP_WM_HINT: any
   ...
   *
   */
  static FLAG_MINIMIZE_DISABLED: any
   ...
   *
   */
  static FLAG_MAXIMIZE_DISABLED: any
   ...
   *
   */
  $nonclient_window_input: Signal<() => void>
