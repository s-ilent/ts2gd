...
declare class ParticleProcessMaterial extends Material {
  ...
  connect<T extends SignalsOf<ParticleProcessMaterial>>(
    signal: T,
    method: SignalFunction<ParticleProcessMaterial[T]>
  ): number
  ...
  /** No documentation provided. */
  static SUB_EMITTER_AT_START: any
   ...
   *
   */
  $emission_shape_changed: Signal<() => void>
}
