...
declare class SkeletonModification2DPhysicalBones extends SkeletonModification2D {
  ...
  set_physical_bone_node(
    joint_idx: int,
    physicalbone2d_node: NodePathType
  ): void
  ...
  connect<T extends SignalsOf<SkeletonModification2DPhysicalBones>>(
    signal: T,
    method: SignalFunction<SkeletonModification2DPhysicalBones[T]>
  ): number
}
