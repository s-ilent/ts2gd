...
> = CallableConstructor<T>

declare var Callable: {
  new (): Callable
  new <T extends (...args: any[]) => any = (...args: any[]) => any>(
    func: T
  ): Callable<T>
  new <T extends (...args: any[]) => any = (...args: any[]) => any>(
    from: Callable<T>
...
declare class CallableConstructor<
  T extends (...args: any[]) => any = (...args: any[]) => any
> {
  /**
  ...
  connect<T extends SignalsOf<Callable>>(
    signal: T,
    method: SignalFunction<Callable[T]>
  ): number
}
