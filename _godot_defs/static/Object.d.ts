...
declare class Object {
   ...
   */
  emit_signal<
    U extends (...args: Args) => any,
    T extends Signal<U>,
    Args extends any[]
  >(signal: T, ...args: Args): void
  ...
  connect<T extends SignalsOf<Object>>(
    signal: T,
    method: SignalFunction<Object[T]>
  ): number
   ...
   *
   */
  static NOTIFICATION_EXTENSION_RELOADED: any
   ...
   *
   */
  static CONNECT_APPEND_SOURCE_OBJECT: any
