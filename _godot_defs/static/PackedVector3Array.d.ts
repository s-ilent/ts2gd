...
declare class PackedVector3Array {
  ...
  new(from: PackedVector3Array): PackedVector3Array
  constructor(from: PackedVector3Array)

  new(from: any[]): PackedVector3Array
   ...
   *
   */
  find(value: Vector3, from?: int): int
   ...
   *
   */
  rfind(value: Vector3, from?: int): int
  ...
  connect<T extends SignalsOf<PackedVector3Array>>(
    signal: T,
    method: SignalFunction<PackedVector3Array[T]>
  ): number
}
